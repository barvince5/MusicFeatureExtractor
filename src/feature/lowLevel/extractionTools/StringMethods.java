...
import customException.StringMethodsException;
	...
	public static int getIndexOfString(String given_name, String[] possible_names)
		...
		for (int i = 0; i < possible_names.length; i++)
			if (given_name.equals(possible_names[i]))
				return i;
		throw new StringMethodsException("Unable to find " + given_name + ".");
	}


	/**
	 * Returns a shortened copy of the given array of strings with all duplicate
